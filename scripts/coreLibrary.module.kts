@file:MavenDepends("cf.wayzer:PlaceHoldLib:3.2", "https://dl.bintray.com/way-zer/maven/")
...
@file:MavenDepends("org.jetbrains.exposed:exposed-core:0.29.1", single = false)
@file:MavenDepends("org.jetbrains.exposed:exposed-dao:0.29.1", single = false)
@file:MavenDepends("org.jetbrains.exposed:exposed-java-time:0.29.1", single = false)
@file:MavenDepends("org.jetbrains.exposed:exposed-jdbc:0.29.1", single = false)
