...
@file:MavenDepends("org.jetbrains.exposed:exposed-core:0.28.1", single = false)
@file:MavenDepends("org.jetbrains.exposed:exposed-dao:0.28.1", single = false)
@file:MavenDepends("org.jetbrains.exposed:exposed-java-time:0.28.1", single = false)
@file:MavenDepends("org.jetbrains.exposed:exposed-jdbc:0.28.1", single = false)
